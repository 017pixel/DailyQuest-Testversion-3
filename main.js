            ...
            try {
                ...
                store.get(1).onsuccess = (e) => {
                    ...
                    if (result.outcome === 'win' && result.rewards) {
                        ...
                        if (typeof char.manaStones !== 'number') char.manaStones = 0;
                        char.manaStones += (result.rewards.manaStones || 0);
...
async function initializeApp() {
    try {
        ...
        try {
            ...
            if (char) {
                const combat = {
                    attack: (char.combat && typeof char.combat.attack === 'number') ? char.combat.attack : 0,
                    protection: (char.combat && typeof char.combat.protection === 'number') ? char.combat.protection : 0,
